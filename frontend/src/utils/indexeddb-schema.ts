...
export const INDEX_CONFIG = {
    [DB_CONFIG.STORES.BOOKMARKS]: [
        ...
        { name: 'pathIds', keyPath: 'pathIds', options: { unique: false, multiEntry: true } },
        { name: 'keywords', keyPath: 'keywords', options: { unique: false, multiEntry: true } },
    ...
    [DB_CONFIG.STORES.FAVICON_CACHE]: [
        ...
        { name: 'bookmarkCount', keyPath: 'bookmarkCount', options: { unique: false } },
