...
enabled = true
head_sampling_rate = 0.1  # 追踪 10% 的请求
```
...
log(LogLevel.ERROR, '数据库连接失败', { error: err.message })
```
...
// 使用
const bookmarks = await monitoredOperation(
  'getBookmarks',
